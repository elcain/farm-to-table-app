...
function parse() {
  console.log("You called parse");
  var currentPage = window.location.href;
  console.log("current page url is => " + currentPage);
// return fetch(`${config.MERCATOR_GEOCODING_API_URL}suggest?text=${encodeURIComponent(query)}&f=pjson`)
}
